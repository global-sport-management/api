...
var UserController = /** @class */ (function () {
    function UserController(service, logger) {
        this.service = service;
        this.logger = logger;
    }
    UserController.prototype.logout = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.service.findOneAndLogout(user.id)];
                    case 1:
                        result = _a.sent();
